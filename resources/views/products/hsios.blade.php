        ...
        <div class="max-w-xl mx-auto">
            ...
            <form action="{{ route('waitlist.submit') }}" method="POST" class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <input name="email" type="email" required maxlength="150" aria-label="Work email" placeholder="Work email" class="form-input bg-white/5 border-white/10 text-white placeholder-charcoal-400" value="{{ old('email') }}">
                </div>
                <input name="stage" type="text" maxlength="100" aria-label="Business type" placeholder="Business type (e.g. Hotel, Restaurant, Interior firm)" class="form-input bg-white/5 border-white/10 text-white placeholder-charcoal-400" value="{{ old('stage') }}">
