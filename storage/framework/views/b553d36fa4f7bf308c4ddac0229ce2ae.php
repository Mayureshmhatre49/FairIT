<?php $__env->startSection('title', 'HandleLife OS — AI Operating System for Modern Families | FairIT Solutions'); ?>
<?php $__env->startSection('description', 'HandleLife OS is the AI operating system for modern family life. Health, finances, school, NRI services, and emergency management — intelligently orchestrated for busy families.'); ?>
    ...
    <div class="relative container-tight">
        <div data-animate>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn-outline-white">Learn More</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section-padding bg-charcoal-950">
    <div class="container-wide">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div data-animate data-animate-delay="<?php echo e($i * 80); ?>" class="bg-white/5 hover:bg-white/8 border border-white/10 hover:border-violet-500/30 rounded-2xl p-6 transition-all duration-300 group">
                ...
                <h3 class="font-bold text-white mb-2"><?php echo e($feature['title']); ?></h3>
                <p class="text-charcoal-400 text-sm leading-relaxed"><?php echo e($feature['desc']); ?></p>
            </div>
...
<section class="section-padding bg-white">
    <div class="container-tight">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            <?php $__currentLoopData = ['Modern Families', 'NRIs', 'Busy Professionals', 'Senior Citizens', 'Special-Needs Households']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $who): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div data-animate data-animate-delay="<?php echo e($i * 80); ?>" class="text-center p-5 rounded-2xl border border-charcoal-100 hover:border-brand-200 hover:shadow-card transition-all">
                ...
                <div class="font-semibold text-charcoal-950 text-xs"><?php echo e($who); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mayuresh/Projects/Nishant-Dada/FairIT Solutions/FairITSolutions Website/resources/views/products/handlelife.blade.php ENDPATH**/ ?>