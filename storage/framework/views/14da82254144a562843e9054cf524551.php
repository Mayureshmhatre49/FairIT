<?php $__env->startSection('title', 'FairIT Solutions — AI Operating Systems for Founders, Homes & Life'); ?>
<?php $__env->startSection('description', 'We build AI Operating Systems for ambitious founders, modern businesses, and future-ready teams. AI advisory, custom copilots, voice AI, and managed retainers.'); ?>
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-charcoal-950" aria-label="Hero">
    ...
    <div class="relative container-wide pt-24 pb-20 text-center">
        ...
        <div data-animate data-animate-delay="300" class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="<?php echo e(route('consultation')); ?>" class="btn-primary-lg animate-pulse-glow">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="btn-outline-white">
                Explore Products
        ...
        <div data-animate data-animate-delay="400" class="mt-16 pt-12 border-t border-white/5">
            ...
            <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
                <?php $__currentLoopData = ['Startups', 'SMEs', 'Interior Firms', 'Hospitality', 'Real Estate', 'Professional Services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div data-animate data-animate-delay="500" class="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-3xl mx-auto">
            <?php $__currentLoopData = [['95%', 'AI adoption rate', '95'], ['40+', 'Languages supported', '40'], ['3×', 'Average productivity gain', '3'], ['24/7', 'AI systems uptime', '24']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="text-center">
                <div class="text-3xl lg:text-4xl font-bold text-white"><?php echo e($stat[0]); ?></div>
                <div class="text-xs text-charcoal-500 mt-1"><?php echo e($stat[1]); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="section-padding bg-white" aria-label="Core value pillars">
    <div class="container-wide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div data-animate data-animate-delay="<?php echo e($pillar['delay']); ?>" class="group relative bg-white rounded-2xl p-8 border border-charcoal-100 hover:border-brand-200 hover:shadow-card-hover transition-all duration-300 flex flex-col">
                ...
                <h3 class="text-xl font-bold text-charcoal-950 mb-3"><?php echo e($pillar['title']); ?></h3>
                <p class="text-charcoal-500 text-sm leading-relaxed mb-6 flex-1"><?php echo e($pillar['desc']); ?></p>
                <ul class="space-y-2 mb-8">
                    <?php $__currentLoopData = $pillar['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route($pillar['cta']['route'])); ?>" class="btn-secondary w-full justify-center group-hover:border-brand-300 group-hover:text-brand-700 transition-colors">
                    <?php echo e($pillar['cta']['text']); ?>
...
<section class="section-padding bg-charcoal-50" aria-label="Services preview">
    <div class="container-wide">
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14" data-animate>
            ...
            <a href="<?php echo e(route('services.index')); ?>" class="btn-secondary flex-shrink-0">
                View All Services
                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div data-animate data-animate-delay="<?php echo e($service['delay']); ?>" class="service-card group flex flex-col <?php echo e($loop->last ? 'sm:col-span-2 lg:col-span-1' : ''); ?>">
                <div class="flex items-start justify-between mb-6">
                    ...
                    <span class="text-4xl font-black text-charcoal-100 group-hover:text-brand-100 transition-colors"><?php echo e($service['number']); ?></span>
                </div>
                <h3 class="text-lg font-bold text-charcoal-950 mb-3 group-hover:text-brand-700 transition-colors"><?php echo e($service['title']); ?></h3>
                <p class="text-charcoal-500 text-sm leading-relaxed flex-1 mb-6"><?php echo e($service['desc']); ?></p>
                <a href="<?php echo e(route($service['route'])); ?>" class="btn-ghost p-0 text-brand-600 hover:text-brand-800 font-semibold text-sm group/btn flex items-center gap-1.5">
...
<section class="section-padding bg-charcoal-950 overflow-hidden" aria-label="AI Products">
    <div class="container-wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div data-animate data-animate-delay="<?php echo e($product['delay']); ?>" class="relative bg-gradient-to-br <?php echo e($product['color']); ?> rounded-2xl p-8 border flex flex-col product-glow hover:scale-[1.02] transition-all duration-300 group">
                <div class="flex items-start justify-between mb-8">
                    <div>
                        <span class="inline-block px-2.5 py-1 rounded-md text-xs font-semibold border <?php echo e($product['badge']); ?> mb-3"><?php echo e($product['tag']); ?></span>
                        <h3 class="text-2xl font-bold text-white"><?php echo e($product['name']); ?></h3>
                        <p class="text-charcoal-300 text-sm mt-1"><?php echo e($product['tagline']); ?></p>
                    </div>
                ...
                <p class="text-charcoal-300 text-sm leading-relaxed mb-8 flex-1"><?php echo e($product['desc']); ?></p>
                ...
                <a href="<?php echo e(route($product['route'])); ?>" class="inline-flex items-center justify-between gap-2 w-full bg-white/10 hover:bg-white/20 text-white font-semibold text-sm px-5 py-3 rounded-xl transition-all group-hover:bg-white/15">
                    <span>Explore <?php echo e($product['name']); ?></span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div data-animate>
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('consultation')); ?>" class="btn-primary-lg">Start Your Transformation</a>
                    <a href="<?php echo e(route('about')); ?>" class="btn-secondary-lg">Learn About Us</a>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <?php $__currentLoopData = $whyPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div data-animate data-animate-delay="<?php echo e($point['delay']); ?>" class="flex items-start gap-4 p-5 rounded-xl hover:bg-charcoal-50 transition-colors group">
                    <div class="w-10 h-10 rounded-xl bg-brand-50 flex items-center justify-center flex-shrink-0 group-hover:bg-brand-100 transition-colors">
                        <svg class="w-5 h-5 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                            <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($point['icon']); ?>"/>
                        </svg>
                    </div>
                    <div>
                        <h3 class="font-bold text-charcoal-950 mb-1"><?php echo e($point['title']); ?></h3>
                        <p class="text-charcoal-500 text-sm leading-relaxed"><?php echo e($point['desc']); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<section class="section-padding bg-charcoal-50" aria-label="Industries served">
    <div class="container-wide">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <a href="<?php echo e(route('industries.show', $industry['slug'])); ?>" data-animate data-animate-delay="<?php echo e($industry['delay']); ?>" class="group bg-white rounded-2xl p-6 border border-charcoal-100 hover:border-brand-200 hover:shadow-card-hover transition-all duration-300 text-center flex flex-col items-center">
                <div class="w-12 h-12 rounded-xl bg-charcoal-50 flex items-center justify-center mb-4 group-hover:bg-brand-50 transition-colors">
                    <svg class="w-6 h-6 text-charcoal-500 group-hover:text-brand-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($industry['icon']); ?>"/>
                    </svg>
                </div>
                <span class="text-sm font-semibold text-charcoal-800 group-hover:text-brand-700 transition-colors"><?php echo e($industry['name']); ?></span>
...
<section class="section-padding bg-white" aria-label="Testimonials">
    <div class="container-wide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div data-animate data-animate-delay="<?php echo e(($loop->index * 100)); ?>" class="bg-white rounded-2xl p-8 border border-charcoal-100 hover:shadow-card-hover transition-all duration-300 flex flex-col">
                
                <div class="flex gap-1 mb-4">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                    <svg class="w-4 h-4 <?php echo e($i <= $t->rating ? 'text-amber-400' : 'text-charcoal-200'); ?>" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                    </svg>
                    <?php endfor; ?>
                </div>

                <blockquote class="text-charcoal-600 text-sm leading-relaxed flex-1 mb-6">"<?php echo e($t->content); ?>"</blockquote>

                <div class="flex items-center gap-3">
                    <?php if($t->avatar): ?>
                    <img src="<?php echo e($t->avatar); ?>" alt="<?php echo e($t->name); ?>" class="w-10 h-10 rounded-full object-cover" loading="lazy">
                    <?php else: ?>
                    <div class="w-10 h-10 rounded-full bg-brand-100 flex items-center justify-center flex-shrink-0">
                        <span class="text-brand-700 font-bold text-sm"><?php echo e(substr($t->name, 0, 1)); ?></span>
                    </div>
                    <?php endif; ?>
                    <div>
                        <div class="text-sm font-bold text-charcoal-900"><?php echo e($t->name); ?></div>
                        <div class="text-xs text-charcoal-500"><?php echo e($t->role); ?><?php echo e($t->company ? ' · ' . $t->company : ''); ?></div>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div data-animate data-animate-delay="<?php echo e($i * 150); ?>" class="bg-charcoal-50 rounded-2xl p-8 border border-charcoal-100 flex flex-col">
                <div class="flex gap-1 mb-4">
                    <?php for($star = 0; $star < 5; $star++): ?><svg class="w-4 h-4 text-amber-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg><?php endfor; ?>
                </div>
                <blockquote class="text-charcoal-600 text-sm leading-relaxed flex-1 mb-6">"<?php echo e($t['content']); ?>"</blockquote>
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-brand-100 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        <div class="text-sm font-bold text-charcoal-900"><?php echo e($t['name']); ?></div>
                        <div class="text-xs text-charcoal-500"><?php echo e($t['role']); ?></div>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section class="section-padding bg-charcoal-50" aria-label="Latest insights">
    <div class="container-wide">
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14" data-animate>
            ...
            <a href="<?php echo e(route('blog.index')); ?>" class="btn-secondary flex-shrink-0">
                View All Insights
                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('blog.show', $post->slug)); ?>" data-animate data-animate-delay="<?php echo e($loop->index * 100); ?>" class="group bg-white rounded-2xl overflow-hidden border border-charcoal-100 hover:shadow-card-hover transition-all duration-300 flex flex-col">
                <?php if($post->featured_image): ?>
                <div class="aspect-video bg-charcoal-100 overflow-hidden">
                    <img src="<?php echo e($post->featured_image); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <?php else: ?>
                ...
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <span class="badge badge-blue mb-3"><?php echo e($post->category); ?></span>
                    <?php endif; ?>
                    <h3 class="font-bold text-charcoal-950 group-hover:text-brand-700 transition-colors mb-2 line-clamp-2"><?php echo e($post->title); ?></h3>
                    <p class="text-charcoal-500 text-sm leading-relaxed flex-1 line-clamp-3 mb-4"><?php echo e($post->excerpt); ?></p>
    ...
    <div class="relative container-tight text-center">
        <div data-animate>
            ...
            <div class="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-charcoal-500">
                <?php $__currentLoopData = ['No long-term contracts required', '24h response guaranteed', 'Confidentiality assured', 'Based in Switzerland']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mayuresh/Projects/Nishant-Dada/FairIT Solutions/FairITSolutions Website/resources/views/home.blade.php ENDPATH**/ ?>