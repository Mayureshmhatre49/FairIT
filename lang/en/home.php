...
return [
    ...
    'stats' => [
        ...
        ['value' => '47',   'label' => 'Named enterprise clients',     'num' => '47'],
    ...
    'testimonials' => [
        ...
        'items' => [
            ['name' => 'Dr. Sarah Jenkins',  'role' => 'Chief Medical Officer', 'company' => 'Callidus Health LLC', 'content' => 'CareLink transformed patient coordination for our care teams. Unifying EMR alerts and secure chat reduced response latency on critical signals while removing compliance-risky tools from our clinical workflows.'],
            ['name' => 'Thomas Wright',      'role' => 'Head of Data Science', 'company' => 'CoreBrand Data Science LLC', 'content' => 'The custom SPSS visualization product turned complex statistical models into clear, decision-ready dashboards. Brand decisions that previously cycled for weeks now close in days.'],
            ['name' => 'Rajesh Kumar',       'role' => 'Director of Urban Planning', 'company' => 'Madhya Pradesh Urban Ministry', 'content' => 'Moving Burhanpur and Khandwa from paper surveys to a single door-to-door GIS source of truth transformed our civic planning. It enabled property targeting that was previously impossible at scale.'],
        ],
    ],
    'insights' => [
